...
#include "../listener/FromCliOpListener.h"

namespace inet {

Define_Module(ServerEvilOperator);

void ServerEvilOperator::initialize(int stage) {
    ...
    if (stage == INITSTAGE_LOCAL) {
        ...
        clientCompListener = new FromCliOpListener(this);
...
void ServerEvilOperator::sendPacketDeparture(const MmsMessage* appmsg) {
...
void ServerEvilOperator::handleDeparture() {
...
void ServerEvilOperator::handleMessage(cMessage *msg)
{
...
void ServerEvilOperator::handleForward() {
...
void ServerEvilOperator::finish() {
...
ServerEvilOperator::~ServerEvilOperator() {
