...
#ifndef __MQTT_MMS_MEDIUM_HTTPCLIENTOPERATOR_H_
#define __MQTT_MMS_MEDIUM_HTTPCLIENTOPERATOR_H_
...
class HttpClientOperator : public TcpAppBase, public IOperator {
public:
