...
#ifndef OPERATION_ATTACKER_CONCRETE_FORWARDMMSMESSAGETOCLIENT_H_
#define OPERATION_ATTACKER_CONCRETE_FORWARDMMSMESSAGETOCLIENT_H_
...
#endif /* OPERATION_ATTACKER_CONCRETE_FORWARDMMSMESSAGETOCLIENT_H_ */
