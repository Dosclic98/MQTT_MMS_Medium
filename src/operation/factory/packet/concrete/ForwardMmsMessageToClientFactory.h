...
#ifndef OPERATION_FACTORY_PACKET_CONCRETE_FORWARDMMSMESSAGETOCLIENTFACTORY_H_
...
#endif /* OPERATION_FACTORY_PACKET_CONCRETE_FORWARDMMSMESSAGETOCLIENTFACTORY_H_ */
