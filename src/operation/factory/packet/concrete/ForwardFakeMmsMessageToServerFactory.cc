...
#include "ForwardFakeMmsMessageToServerFactory.h"
#include "../../../attacker/concrete/ForwardMmsMessageToServer.h"

using namespace inet;

void ForwardFakeMmsMessageToServerFactory::build(Packet* packet) {
...
ForwardFakeMmsMessageToServerFactory::ForwardFakeMmsMessageToServerFactory(MmsAttackerController* controller) {
