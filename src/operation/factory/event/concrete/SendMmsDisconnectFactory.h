...
#ifndef OPERATION_FACTORY_EVENT_CONCRETE_SENDMMSDISCONNECTFACTORY_H_
#define OPERATION_FACTORY_EVENT_CONCRETE_SENDMMSDISCONNECTFACTORY_H_
...
#endif /* OPERATION_FACTORY_EVENT_CONCRETE_SENDMMSDISCONNECTFACTORY_H_ */
