...
#ifndef OPERATION_FACTORY_EVENT_CONCRETE_SENDMMSREQUESTFACTORY_H_
#define OPERATION_FACTORY_EVENT_CONCRETE_SENDMMSREQUESTFACTORY_H_
...
#endif /* OPERATION_FACTORY_EVENT_CONCRETE_SENDMMSREQUESTFACTORY_H_ */
