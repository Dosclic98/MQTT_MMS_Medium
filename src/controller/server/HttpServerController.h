...
#ifndef __MQTT_MMS_MEDIUM_HTTPSERVERCONTROLLER_H_
#define __MQTT_MMS_MEDIUM_HTTPSERVERCONTROLLER_H_

#include "../IController.h"

namespace inet {

class HttpServerController : public cSimpleModule, public IController {
...
public:
    ...
    virtual ~HttpServerController();

protected:
    cMessage* departureEvent = new cMessage("Send HTTP Response event");
